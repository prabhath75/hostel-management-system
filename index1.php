...
<style>
        body {
 background-image: url("./dist/images/backg.webp");
        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-md-2 col-sm-2 col-xs-2">
                           <a  href="index.php" target="_self"><img style="width:50px;" src="dist/images/EDF Logo (1).png" alt="Logo"></a>
                        </div>
                ...
                <div class="panel-body">
                    <form name="login" action="index1.php" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <button type="submit" name="btnLogin" class="btn btn-lg btn-info btn-block"><i class="glyphicon glyphicon-log-in"></i> Log in</button>
                            
                        </fieldset>
                    </form>
                </div>
                 <a style="text-decoration:none; color:azure;" href="home.php">
                 <button type="submit"class="btn btn-lg btn-info btn-block">HOME</button>
                </a>
            </div>
        </div>
    </div>
