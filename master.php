...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <img style="width:45px;margin:5px ;" alt="HMS" class="pull-left" src="<?php echo $base_url.'site/images/EDF_logo.png'?>"><a class="navbar-brand titlehms" href="<?php echo $base_url.'dashboard.php'?>">Hostel Management System</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="<?php echo $base_url;?>home.php"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo $base_url.'ui/studentManage/admission.php'?>">Add Student</a>
                            </li>
                            <!-- <li>
                    ...
                    <!-- repert -->
                    <li>
                     <a href="#"><i class="fa  fa-file-text  fa-fw"></i>Generate report<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <!-- <li>
                                <a href="<?php echo $base_url.'report/report1.php'?>">Student repo</a>
                            </li> -->
                            
                            <li>
                                <a href="<?php echo $base_url.'ui/studentManage/studentlist.php'?>">List of student</a>
                            </li>
                            <li>
                                <a href="<?php echo $base_url.'ui/employee/view.php'?>">List of Employee</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo $base_url.'ui/setting/adduser.php'?>">System Admin User add/edit</a>
                            </li>
