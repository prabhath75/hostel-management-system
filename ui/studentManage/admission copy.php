                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input required  type="text" placeholder="Full Name" class="form-control" name="name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input required type="text" placeholder="Student Id" class="form-control" name="stdId" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  required maxlength="10" type="text" placeholder="Mobile No" class="form-control" name="cellNo" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input required type="password" id="password" placeholder="" class="form-control" name="password" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-key"></i> </span>
                                                <input required type="password" id="rePassword" placeholder="" class="form-control" name="rePassword" >
                                            </div>
                                        </div>
                                    ...
                                    <!-- <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder="Name Of Institute" class="form-control" name="nameOfInst" >
                                            </div>
                                        </div>
                                    </div> -->
                                    <!-- <div class="col-lg-4">
                                    ...
                                    <!-- <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder="Batch No" class="form-control" name="batchNo" >
                                            </div>
                                        </div>
                                    </div> -->
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-info"></i> </span>
                                                <input required max="" type="text" placeholder="National Id" class="form-control" name="nationalId" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-info"></i> </span>
                                                <input max="8" type="text" placeholder="Passport No" class="form-control" name="passportNo">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-leaf"></i> </span>
                                                <input maxlength="20" type="text" placeholder="Father Name" class="form-control" name="fatherName" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-mobile-phone"></i> </span>
                                                <input required type="text" max="10" placeholder="Mobile No" class="form-control" name="fatherCellNo" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-leaf"></i> </span>
                                                <input maxlength="20" type="text" placeholder="Mother Name" class="form-control" name="motherName" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-mobile-phone"></i> </span>
                                                <input max="10" type="text" placeholder="Mobile No" class="form-control" name="motherCellNo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-leaf"></i> </span>
                                                <input maxlength="20" type="text" placeholder="Guardian Name" class="form-control" name="localGuardian" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-mobile-phone"></i> </span>
                                                <input maxlength="10" type="text" placeholder="Mobile No" class="form-control" name="localGuardianCell" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea rows="3" placeholder="Address" class="form-control" name="presentAddress" > </textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-road"></i> </span>
                                                <textarea rows="3" placeholder="Parmanent Address" class="form-control" name="parmanentAddress" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
