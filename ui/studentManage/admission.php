                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder="Student Id" class="form-control" name="stdId" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder="Mobile No" class="form-control" name="cellNo" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-key"></i> </span>
                                                <input type="password" id="rePassword" placeholder="" class="form-control" name="rePassword" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-leaf"></i> </span>
                                                <input type="text" placeholder="Father Name" class="form-control" name="fatherName" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-mobile-phone"></i> </span>
                                                <input type="text" placeholder="Mobile No" class="form-control" name="fatherCellNo" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-leaf"></i> </span>
                                                <input type="text" placeholder="Mother Name" class="form-control" name="motherName" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-mobile-phone"></i> </span>
                                                <input type="text" placeholder="Mobile No" class="form-control" name="motherCellNo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-leaf"></i> </span>
                                                <input type="text" placeholder="Guardian Name" class="form-control" name="localGuardian" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-mobile-phone"></i> </span>
                                                <input type="text" placeholder="Mobile No" class="form-control" name="localGuardianCell" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-road"></i> </span>
                                                <input type="text" placeholder="city" class="form-control" name="parmanentAddress"  ></>
                                            </div>
                                        </div>
                                    </div>
                                </div>
