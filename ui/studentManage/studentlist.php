...
else
{
    ...
    if ($msg = "true") {
        ...
        $results = $db->execDataTable("SELECT DISTINCT parmanentAddress from studentinfo ");
        $GLOBALS['output']='';
        if(false===strpos((string)$result,"Can't"))
        {
            ...
            while ($row = mysql_fetch_array($result)) {
                ...
                $GLOBALS['output'] .= "<td>" . $row['parmanentAddress'] . "</td>";
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <button onclick="window.print()" style="margin:10px; width:100px;" class="btn btn-primary">Print</button><br>
                    <select name="mydropdown">
                       <?php while($row = mysql_fetch_assoc($results)) { ?>
                       <option value="<?php echo $row['parmanentAddress']; ?>"><?php echo $row['parmanentAddress']; ?></option>
                        <?php } ?>
                    </select>
