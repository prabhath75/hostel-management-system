...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <img alt="HMS" style="width: 45px;" class="pull-left" src="<?php echo $base_url.'site/images/EDF_logo.png'?>"><a class="navbar-brand titlehms" href="<?php echo $base_url.'sdashboard.php'?>">Hostel Management System</a>
        </div>
        <!-- /.navbar-header -->
